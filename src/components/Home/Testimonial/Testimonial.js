        ...
        <div class="mb-16 ">
            <div class="bg-gray-100">
                <div class="container flex justify-center mx-auto pt-16">
                    <div>
                        <p class="label-text text-center">BUILDING TEAM</p>
                        <h1 class="heading-2 text-center">The Talented People <br /> Behind the Scenes of the Organization</h1>
                    </div>
                </div>
                <div class=" w-full px-10 pt-10">
                    <div class="px-3 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-20 lg:px-8 mt-10">
                        <div role="list" aria-label="Behind the scenes People " class="lg:flex md:flex sm:flex items-center xl:justify-between flex-wrap md:justify-around sm:justify-around lg:justify-around">
                            {peoples.map(people => <div role="listitem" class="xl:w-1/3 sm:w-3/4 md:w-2/5 relative mt-16 mb-32 sm:mb-24 xl:max-w-sm lg:w-2/5">
                                <div class="rounded overflow-hidden shadow-md bg-white">
                                    <div class="absolute -mt-20 w-full flex justify-center">
                                        <div class="h-32 w-32">
                                            <img src={people.image} alt= {`Pictures of ${people.name}`}  class="rounded-full object-cover h-full w-full shadow-md" />
                                        </div>
                                    </div>
                                    <div class="px-6 mt-16 pb-5">
                                        <h1 class="font-bold text-3xl text-center mb-1">{people.name}</h1>
                                        <p class="text-gray-800 text-sm text-center">{people.designation}</p>
                                        <p class="text-center text-gray-600 text-base pt-3 font-normal">{people.description}</p>
                                    </div>
                                </div>
                            </div>)}
                        </div>
